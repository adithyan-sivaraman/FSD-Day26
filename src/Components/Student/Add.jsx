...
const CreateStudent = () => {
    ...
    return (
        <div className="flex flex-col w-full ml-2 mt-2">
            <p className="px-4 text-lg font-bold tracking-wider">Create Student</p>
            <form onSubmit={createForm.handleSubmit}>
                ...
                <div className="flex flex-col sm:flex-row px-4 py-2 w-full sm:w-4/5 lg:w-3/4">
                    ...
                    <select
                        ...
                        name='standard'
                        onChange={createForm.handleChange}
                        value={createForm.values.standard} >
                        <option value=''>--Select--</option>
                ...
                <div className="flex flex-col sm:flex-row px-4 py-2 w-full sm:w-4/5 lg:w-3/4">
                    ...
                    <input
                        ...
                        name='admission'
                        onChange={createForm.handleChange}
                        value={createForm.values.admission} />
                </div>
                <div className="flex flex-col sm:flex-row px-4 py-2 w-full sm:w-4/5 lg:w-3/4">
            ...
            {dialogHidden && (
                <dialog className="fixed top-0 flex flex-col items-center border rounded-md bg-gray-500 text-white">
                    ...
                    <p className="text-xl  px-4 py-2 tracking-wider">Student created successfully</p>
                </dialog>
            )}
